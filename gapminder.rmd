...
ggplot(gap1, aes(year, Mean.PopMil)) +
  ...
  xlab("Year") +
  ylab("Population (millions)") +
  theme(legend.title=element_blank())+ggtitle("Figure1 Mean Life Expextancy by Continent over time")
```
...
ggplot(gap1, aes(year, Mean.gdpPercap)) +
  ...
  xlab("Year") +
  ylab("GDP per capita") +
  theme(legend.title=element_blank())+ggtitle("Figure2 Mean Population by Continent over time")
```
