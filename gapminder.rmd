...
We created four different linear models and assessed fit with the Akaike information criterion (AIC). The model with the best fit was an ANCOVA model which assigned the DV as LifeExpectancy, and the categorical IV as the year and the covariate as the gdpPercap. 
