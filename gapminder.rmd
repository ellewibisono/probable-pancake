...
```
Figure 1a. Mean life expectancy by continent over time (years 1952-2007). Bars indicate standard error of the mean. Regression model for life expectancy by year. Life expectancy was significantly predicted by year p<0.001, with a large effect R2 = 0.19. 
...
```
Figure 2a. Mean population by continent over time (years 1952-2007). Bars indicate standard error of the mean.Regression model for population by year. Population in millions was significantly predicted by year p<0.001, with a minimal effect R2 = 0.006.
